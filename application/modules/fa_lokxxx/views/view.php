            ...
            <div class="x_title">
                ...
                <div class="row">
                    ...
                    <div  class="col-md-6 col-xs-3">
                       <?php
                        echo anchor(
                                site_url('fa_lokxxx/add'), '<i class="glyphicon glyphicon-plus"></i> Tambah Data', 'class="btn btn-success btn-sm" data-tooltip="tooltip" data-placement="top" title="Tambah Data"'
                        );
                        ?>
                    </div>
