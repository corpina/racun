...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
                <h2>Tabel Komponen Iuran Siswa</h2>
            ...
            <div class="x_title">
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-3">
                        <?php
                        echo anchor(
                                site_url('komponen_iuran/add'), '<i class="glyphicon glyphicon-plus"></i> Tambah Data', 'class="btn btn-success btn-sm" data-tooltip="tooltip"'
                        );
                        ?>
                    </div>
