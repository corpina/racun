        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label for="nama_jenjang" class="col-md-2 control-label">Kode Tingkatan<span class="required-input">*</span></label>
                    <div class="col-md-6">                                   
                        <?php
                        echo form_input(
                                array(
                ...
                <div class="form-group">
                    <label for="nama_jenjang" class="col-md-2 control-label">Nama Tingkatan<span class="required-input">*</span></label>
                    <div class="col-md-6">                                   
                        <?php
                        echo form_input(
                                array(
