            ...
            <div class="x_content">
                    ...
                    <div class="col-md-3">                                   
                        ...
                        echo form_input(
                                array(
                                    ...
                                    'maxlength' => '10',
                                    'required' => 'required'
                                )//, set_value('KETX_THN', $tb_descthnajar['KETX_THN'])
                        );
                        ?>
                        <?php echo form_error('KETX_THN'); ?>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">                                   
                        ...
                        <input type="text" class="form-control" placeholder=" Tanggal Awal" required="required" name="tanggal_awal" id="tanggal_awal" data-inputmask="'mask': '99/99/9999'">

                        <?php echo form_error('TGLX_STRT'); ?>
                    </div>
                    <div class="col-md-3">                                   

                        <input type="text" class="form-control" placeholder=" Tanggal Akhir" required="tanggal_akhir" name="tanggal_akhir" id="tanggal_akhir" data-inputmask="'mask': '99/99/9999'">
