                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-home"></i> Manajemen <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="<?= base_url() ?>tb_descthnajar">Tahun Ajar</a>
                                        </li>
                                        <li><a href="<?= base_url() ?>fa_lokxxx"> Lokasi</a></li>
										<li><a href="<?= base_url() ?>fa_unitxx"> Unit</a></li>
										<li><a href="<?= base_url() ?>th_mkelas"> Pembuatan Kelas</a></li>
                                        <!--<li><a href="index3.html">Dashboard3</a>-->
										<li><a href="<?= base_url() ?>th_codexd"> Pembuatan Jenjang </a></li>
                                        </li>
                                    </ul>
                                </li>
								...
								<li><a><i class="fa fa-home"></i> Keuangan <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
										...
										<li><a href="<?= base_url() ?>tk_compxh">Jenis Iuran Siswa</a></li>
