...
(5, 'Kantor Pusat Yayasan', 'Jl. Merdeka Raya Bekasi', '021', '021'),
(6, 'SMK Tetarai Putih Global 2 Bekasi', 'Jl Rajawali v no.29 Bekasi Selatan - Kota Bekasi', '021', '021');
...
('002', '1212', '201', 'kelas1a', 2, '', NULL),
('002', '1314', '200', 'kelas 1a', 2, '', NULL),
('002', '1314', '201', '1', 2, '', NULL),
('002', '1516', '200', 'kelas Ibnu Umar', 2, '', NULL);
...
('01', '1314', '2013/2014', '2013-07-01', '2014-06-30', NULL, NULL, NULL, NULL, NULL),
('01', '1415', '2014/2015', '2014-07-01', '2015-06-30', NULL, NULL, NULL, NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `tb_coaxxx` (
...
--
-- Dumping data for table `tb_coaxxx`
--
...
CREATE TABLE IF NOT EXISTS `unit_sekolah` (
...
('002', 'SDM', '5', 'Bagian SDM'),
('003', 'SD RIANG GEMBIRA', '3', 'sekolah luar biasa'),
('004', 'GM', '5', 'Bagian General Manager');
...
ALTER TABLE `jenis_iuran`
 ADD KEY `kode_unit` (`kode_unit`,`kode_iuran`), ADD KEY `kode_iuran` (`kode_iuran`);
...
ALTER TABLE `tabel_jenjang`
 ADD PRIMARY KEY (`kode_jenjang`), ADD KEY `kode_jenjang` (`kode_jenjang`);

--
-- Indexes for table `tabel_kelas`
--
ALTER TABLE `tabel_kelas`
 ADD PRIMARY KEY (`thn_ajar`,`kode_kelas`,`kode_jenjang`,`jurusan_kelas`), ADD KEY `kode_unit` (`kode_unit`), ADD KEY `kode_unit_2` (`kode_unit`), ADD KEY `kode_kelas` (`kode_kelas`), ADD KEY `kode_jenjang` (`kode_jenjang`), ADD KEY `jurusan_kelas` (`jurusan_kelas`), ADD KEY `kode_jenjang_2` (`kode_jenjang`);

--
-- Indexes for table `tabel_umum`
--
ALTER TABLE `tabel_umum`
 ADD PRIMARY KEY (`kode_umum`);

--
-- Indexes for table `tahun_ajar`
--
ALTER TABLE `tahun_ajar`
 ADD PRIMARY KEY (`kode_thn_ajar`,`thn_ajar`);

--
-- Indexes for table `unit_sekolah`
--
ALTER TABLE `unit_sekolah`
 ADD PRIMARY KEY (`kode_unit`), ADD KEY `kode_unit` (`kode_unit`), ADD KEY `kode_unit_2` (`kode_unit`);
...
--
ALTER TABLE `lokasi_sekolah`
MODIFY `kode_lokasi` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `tabel_jenjang`
MODIFY `kode_jenjang` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tabel_umum`
--
ALTER TABLE `tabel_umum`
MODIFY `kode_umum` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- Constraints for dumped tables
--

--
-- Constraints for table `jenis_iuran`
--
ALTER TABLE `jenis_iuran`
ADD CONSTRAINT `jenis_iuran_ibfk_1` FOREIGN KEY (`kode_unit`) REFERENCES `unit_sekolah` (`kode_unit`),
ADD CONSTRAINT `jenis_iuran_ibfk_2` FOREIGN KEY (`kode_iuran`) REFERENCES `tabel_iuran` (`kode_iuran`);
